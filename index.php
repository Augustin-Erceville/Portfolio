        ...
        <div class="row">
            <div class="col-3">
                <div id="list-example" class="list-group">
                    ...
                    <a class="list-group-item list-group-item-action text-center" href="#list-item-2">Compétences</a>
                    <a class="list-group-item list-group-item-action text-center" href="#list-item-3">Expériences</a>
